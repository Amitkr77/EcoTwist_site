...
export default function TermsOfService() {
  return (
    <>
      <Head>
        <title>Terms of Service — Ecotwist innovtions Pvt Ltd</title>
        <meta
          name="description"
          content="Terms of Service for Ecotwist innovtions Private Limited"
        />
      </Head>
          ...
          <section className="prose prose-gray max-w-none prose-h2:text-gray-800 prose-h3:text-gray-700 prose-p:text-gray-600 prose-li:text-gray-600 prose-a:text-blue-600 prose-strong:text-gray-900">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <p>
                ...
                <br />
                Near Euro Kids Play School, Mahavir Colony, Beur, Patna 800002
                (Bihar)
              </p>
              <p>
                <strong>Office Address:</strong>
                <br />
                B-Hub, 5th Floor, A Block, Mauryalok Complex, Patna 800001
                (Bihar)
              </p>
              <p>
              ...
              <p>
                ...
                <a  className="text-blue-600 hover:underline" href="https://ecotwist.in">https://ecotwist.in</a>
              </p>
            </div>

            <h2>1. Introduction and Acceptance of Terms</h2>
            <p>
              Welcome to Ecotwist Innovtions Private Limited ("the Company," "we," 
              "us," or "our"). These Terms of Service ("ToS") govern your access 
              to and use of our website,{" "}
              <a href="https://ecotwist.in">https://ecotwist.in</a>, and all related 
              services, products, content, and functionalities (collectively, the "Services").
            </p>
            <p>
              By accessing or using our Services, you agree to be bound by these 
              ToS and our Privacy Policy. If you do not agree with any part of 
              these terms, you must not use our Services. These ToS constitute a 
            ...
            <p>
              ...
              of age or have the consent of a legal guardian. The Services are not 
              intended for use by individuals under the age of 18 without parental 
              supervision.
            </p>
            ...
            <p>
              ...
              images, product designs, and software on the website, is the 
              exclusive property of Ecotwist Innovtions Private Limited or its 
            ...
            <p>
              ...
              use. Any unauthorized use, including reproduction, modification, 
            ...
            <p>
              We strive to provide accurate and detailed product descriptions. 
              However, we do not guarantee that the product descriptions, colors, 
              or other content are entirely accurate, complete, or error-free. The 
              actual product may vary slightly from the images displayed on the website.
            </p>
            <h3>4.2 Pricing</h3>
            <p>
              ...
              change prices at any time without prior notice. The price charged to 
              you will be the price listed on the website at the time of your order.
            </p>

            <h2>5. Orders, Shipping, and Returns</h2>
            <h3>5.1 Order Acceptance</h3>
            <p>
              Your order is an offer to purchase a product. We reserve the right 
              to accept or reject this offer for any reason, including but not 
              limited to product availability, an error in the product description 
              or price, or a security issue.
            </p>
            <h3>5.2 Shipping</h3>
            <p>
              We will ship your order to the address provided by you. We are not 
              responsible for delays or non-delivery due to incorrect or incomplete 
              address information. For more details on shipping, please refer to our FAQ page.
            </p>
            <h3>5.3 Returns and Refunds</h3>
            <p>
              All returns and refunds are governed by our Return and Refund Policy, 
              which is incorporated by reference into these ToS. By placing an 
              order, you agree to the terms of that policy.
            </p>
            ...
            <p>
              ...
              content, materials, or products included on the website. To the 
            ...
            <p>
              To the maximum extent permitted by law, Ecotwist Innovtions Private 
              Limited, its directors, employees, or agents shall not be liable for 
              any indirect, incidental, special, consequential, or punitive damages, 
              including but not limited to loss of profits, data, or goodwill. Our 
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Ecotwist Innovtions 
              Private Limited and its affiliates, directors, officers, employees, 
              ...
              or in any way connected with your access to or use of the Services or 
            ...
            <p>
              ...
              of India. You agree that any dispute or claim arising out of or in 
              connection with these ToS shall be subject to the exclusive 
              jurisdiction of the courts in Patna, Bihar.
            </p>

            <h2>11. Changes to the Terms of Service</h2>
            <p>
              We reserve the right to modify these ToS at any time, effective upon 
