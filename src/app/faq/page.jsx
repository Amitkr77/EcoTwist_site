    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Send details (product, quantity, customization, timeline) to  <a href='mailto:support@ecotwist.in'>support@ecotwist.in</a>. We’ll review and share a detailed quote.",
        },
        {
  ...
  return (
    <div>
      <div className="container  mx-auto px-6 py-12 text-slate-700">
        ...
        <p className="mb-10">
          Here are some of the most common questions we receive. If you can't
          find what you’re looking for, please contact us at{" "}
          <a
